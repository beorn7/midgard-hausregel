...
\usepackage{german,anysize,eurosym}
...
\author{Bj"orn~Rabenstein\\ b.rabenstein@gmx.de}
\title{Regelklarstellungen, -änderungen und -ergänzungen f"ur
  \textsc{Midgard} (4. Auflage)\\Version 2.1}
...
diese spezielle Realit"at folgt. Sie dient auch dem Spielleiter,
...
der Eindruck von Willk"ur oder Ungerechtigkeit entsteht. Die
wichtigste Regel bleibt, da"s der Spielleiter immer recht hat und
erhaben "uber jede Regel ist. Die hier folgenden Klarstellungen und
"Anderungen sollen in diesem Sinne lediglich vermeidbare
"Uberraschungen verhindern, insbesondere bei Spielern, die sich sehr
auf den gedruckten Regeltext verlassen.

Generell folgen diese Regelerg"anzungen der Philosophie, da"s
...
Die Kampfregeln verfolgen hier zudem noch das Ziel, SpF m"oglichst
selten durch einen von ihnen nicht zu verhindernden W"urfelwurf wenig
glorreich umzubringen, wie das bei Scharfschu"sangriffen aus dem
Hinterhalt m"oglich ist. Die entsprechenden Regeln f"ur gezielte
Angriffe wurden daher leicht entsch"arft, auch wenn dies sicher dem
"`Realismus"' widerspricht. Die ebenfalls nicht sehr realistische
Alternative w"are es, als Spielleiter den SpF niemals einen wirklichen
Hinterhalt zu legen, weil die Wahrscheinlichkeit f"ur eine
frustrierende Form des Ablebens viel zu gro"s ist.

Diese Klarstellungen, Änderungen und Ergänzungen der offiziellen
Midgardregeln sind den Erfahrungen un\-zäh\-liger Midgardsitzungen
seit 1987 entwachsen, insbesondere denen meiner in unterschiedlichen
Zusammensetzungen seit 1989 mehr oder weniger regelmäßig tagenden
"`Hauptrunde"', in der ich häufig die Aufgabe des Spielleiters
übernommen habe. Aufgeschrieben wurden sie von mir, aber ich hege die
Hoffnung, daß sie dem Gruppenkonsens Ausdruck verleihen.

Seit Version~2.0 beziehen sich diese Regelergänzungen auf die
4.~Auflage des Midgard-Regelwerks. Verweise auf das Regelwerk werden
in der Form [XXX\,nnn] gegeben, wobei XXX ein Kürzel für das jeweilige
Buch ist, während nnn die Seitenzahl angibt. Folgende Kürzel finden
Verwendung: DFR = Das Fantasy-Rollenspiel, ARK = Das Arkanum, KOM =
Das Kompendium, BES = Das Bestiarium, MDS = Meister der Sphären.
...
\item In [DFR\,120] linke Spalte, vorletzter Absatz steht geschrieben, daß ein
  ...
  hingegen, daß der Spielleiter vor jedem Schuß auf Ziele außerhalb des
  ...
  Automatismus, sondern dem Spielleiter überlassen.
\end{itemize}
...
\item Der \textbf{automatische} EW f"ur Entdeckungs- und Wissensfertigkeiten
  ...
  Spielleiterentscheidung auch ein \textbf{normaler Erfolg} reichen, und ein
...
\item \textbf{\emph{Alchimie}} [DFR\,130], \textbf{\emph{Giftmischen}}
  ...
  \begin{itemize}
  \item Generell sollte sich der Spielleiter eher großzügig zeigen, was die
    ...
    (z.\,B. \emph{Heilkunde, Giftmischen, Kräuterkunde} und
    \emph{Pflanzenkunde} bei der Frage, ob und wie ein bestimmtes Kraut gegen
    ...
    verschiedene Herangehensweisen an dasselbe Problem).
  \item \emph{Alchimie} ist die allgemeinste der angesprochenen Fertigkeiten.
    ...
    Substanzen oder die gleichzeitige Verwendung von Substanzen
  ...
  \item Die \emph{Kräuterkunde} wird auch im Regelwerk schon relativ klar von
    ...
    eher die Weiterverarbeitung und Anwendung der verarbeiteten pflanzlichen
...
\item \emph{\textbf{Geschäftstüchtigkeit: }}Abweichend vom Regelwerk spart
  ...
  Lebensunterhalt.)
\item Beim \textbf{\emph{Meucheln}} Nach [DFR\,160ff] mu"s mindestens 1\,LP
  ...
  jedoch nicht ber"ucksichtigt. (Einen Dolch durch eine
  Plattenr"ustung ins Herz zu sto"sen, ist fast unm"oglich. Beim
  Erw"urgen mit einer Schnur nutzt die Plattenr"ustung hingegen
  "uberhaupt nicht. Eine Textilr"ustung oder Lederr"ustung bietet
  ...
  aufgehoben.
\item \emph{\textbf{Schleichen}} [DFR\,170]: Wird ein \textbf{Schlafender}
  beschlichen, erh"alt der Schleichende \textbf{WM+4} (wie Ablenkung
  durch schwierige T"atigkeit). Außerdem gilt der Schlafende ans
  besonders unaufmerksam (erwacht nur nach gelungenen WW:Hören). 
...
In der Regel verliert ein Gegner AP entsprechend des
erw"urfelten Schadens. Es gibt jedoch auch indirekte AP-Verluste
(z.\,B. wenn durch den Schlag der Gegner auf die H"alfte seiner LP
reduziert wird und dadurch auch nur noch maximal "uber die H"alfte
seiner AP verf"ugt) und die M"oglichkeit, da"s der Gegner nach dem
Schlag kampfunf"ahig ist. F"ur diese Auswirkungen gibt es nur unter
bestimmten Umst"anden KEP. Bei einem \textbf{normalen Treffer} gibt es
immer nur maximal f"ur den \textbf{direkt erw"urfelten Schaden KEP}
(da"s ein Gegner durch die LP-Verluste dieses Treffers auf die H"alfte
seiner AP reduziert wird oder schwer verletzt zusammenbricht, ist
gewisserma"sen Zufall und erh"oht nicht die durch diesen Treffer
gemachte Erfahrung). Wird ein Gegner durch einen \textbf{kritischen
  Treffer} oder einen \textbf{gezielten Hieb} get"otet, bewu"stlos
oder v"ollig kampfunf"ahig, so erh"alt die SpF ("ahnlich wie ein
Zauberer, der einen Gegner durch einen einzigen Zauber kampfunf"ahig
macht) \textbf{soviele KEP}, als wenn er dem Gegner \textbf{alle seine
  verbliebenen AP} durch normale Angriffe geraubt h"atte.
\textbf{Keine} KEP gibt es f"ur Angriffe, bei denen der Gegner zu
keiner Gegenwehr f"ahig ist, insbesondere \textbf{Fernkampfangriffe
  aus dem Hinterhalt} (also auch beim Scharfschie"sen) oder Angriffe
beim \textbf{Meucheln} [DFR\,268]. Hierf"ur gibt es unter Umst"anden
\textbf{AEP} f"ur die "Uberwindung eines Gegners [DFR\,270f], wobei
der Multiplikator für KEP-Vergabe auch bei den so vergebenen AEP
Berücksichtigung finden kann (Faustregel: Die Anzahl an AEP für die
...
Allerdings sollte der Spielleiter bei Serien von vergeblichen Bannversuchen
...
berechnet, sondern vom Spielleiter je nach Bedeutung des
durchgef"uhrten Zaubers frei bestimmt.

\subsection{Praxispunkte}

PP, die nach den Standardregeln durch einen \textbf{doppelten EW}
vergeben werden, werden grundsätzlich für jeden erfolgreichen EW
vergeben, den der Spielleiter für PP-würdig hält. Es ist also kein
zweiter EW mehr nötig, der mißlingen muß. Dies gilt genauso für
Wissensfertigkeiten, bei denen also auch ein gelungener EW zur
Praxispunktvergabe führt. Der Spielleiter hat ausdrücklich das Recht,
gelungene EW für nicht PP-würdig zu erklären (wenn z.\,B. die
entsprechende Handlung der SpF belanglos war) und in Situationen, wo
ganze Serien von EW für ein und dieselbe Fertigkeit gewürfelt werden,
nur maximal einen PP insgesamt zu vergeben.

Diese Regeländerung soll die PP-bezogene Schwächung allgemeiner
Fertigkeiten durch die 4.~Auflage der Midgard-Regeln ausgleichen.
Außerdem entfallen eine Menge Würfelwürfe, was eine geringere Störung
des Spielablaufs darstellt.
...
\begin{tabular}{|p{16.5cm}|}
  \hline
  \textbf{Beispiel:} \emph{Der Priester Fares lebt in klosterartiger
    ...
    ob sie geeignet sind, einen Priester zu spielen. -- Oxymanos, der
...
natürlich nicht exzessiv ausgenutzt werden und kann in Einzelfällen
vom Spielleiter auch ausgesetzt werden, wenn dies sinnvoll erscheint.
Aber gerade bei sehr umfangreichen Lernvorgängen (z.\,B. die sehr
aufwendige Steigerung eines bereits hohen Erfolgswertes für eine
Waffe) erscheint es umglaubwürdig, daß dies in einem Stück und an
einem Ort zu erfolgen hat.
...
Nahrungsbeschaffung oder die Instandhaltung seines Haushaltes zu k"ummern.
Dazu mu"s er bezahlte Dienstleistungen in Anspruch nehmen. Die
Lebenshaltungskosten lassen sich reduzieren, wenn er derartige Aufgaben selber
...
Selbststudium durch erhöhte Kosten für Lehrmittel und Spesen und durch
die erhöhte Lerndauer erhöhte Lebenshaltungskosten ersetzt wird).
  ...
  \begin{center}
    ...
    {\footnotesize 
      \begin{tabular}{|p{1cm}|c|p{5cm}|p{7.5cm}|}
        ...
        Verf"ugung gestellt, SpF nimmt verringerte Lebensqualit"at hin etc. \\
        \hline
        ...
        unerfahrener Lehrmeister erforderlich, wenn nicht im
        Selbststudium gelernt wird, was zusätzliche Hilfsmittel (spezielle
        Literatur etc.)
        erfordert. Das Selbststudium dauert außerdem doppelt so lange.\\
        \cline{2-4}
        & Geld & Bezahlung des Lehrmeisters & Lehrmeister kann seine Dienste verbilligt
        oder kostenlos zur Verf"ugung stellen. \\
        \hline
        ...
        Bezahlung oder Lernzeit erforderlich. & Lehrmeister kann seine Dienste verbilligt
        oder kostenlos zur Verf"ugung stellen \\
        \hline
      \end{tabular}
      }
...
Lehrmeister. Dies gilt besonders f"ur SpF, die keine so gro"se
...
Eine Ausnahme stellt die Steigerung des AP-Maximums dar. Da für eine SpF
gewissermaßen das "`ganz normale Abenteurerleben"' das Training zur Steigerung
der Ausdauer darstellt, kann sie das AP-Maximum "`nebenbei"' während des
Abentuers, einer Lernphase oder wann auch immer steigern. Dies erfordert immer
\textbf{1~Monat}. Es müssen die \textbf{gesamten FP-Kosten mit EP} beglichen
werden. Der Lebensunterhalt wird in diesem Falle gesondert abgerechnet (wobei
allerdings keine beosnderen Maßnahmen zu ergreifen sind und dieses
Selbststudium auch unter bescheidenen Lebensverhältnissen möglich ist). Bis
auf die Beschränkung, daß die gesamten FP-Kosten mit EP bezahlt werden müssen,
entspricht dies also der AP-Steigerung, wie sie ursprünglich im Regelwerk
vorgesehen ist.
...
Sich \textbf{seitw"arts} oder \textbf{r"uckw"arts} zu bewegen kostet die 
doppelte Feldzahl.

\textbf{Drehungen} um mehr als 45$^\circ$ bis zu 180$^\circ$ kosten
$\frac{\sf 1}{\sf 10}$ der Bewegungsweite.

\subsection{Handlung}

Handlungen werden (theoretisch) \textbf{gleichzeitig angesagt} und
dann in \textbf{Handlungsrang-Reihenfolge durchgef"uhrt}. Eine
angesagte Handlung kann im Nachhinein \textbf{nicht mehr ge"andert}
werden. Allerdings ist es jederzeit m"oglich, eine Handlung
\textbf{abzubrechen}.

\subsection{Rüstungschutz}
...
Eine Figur, die einen \textbf{kritischen Halstreffer} (94--96 auf Tabelle~4.5
[DFR\,247]) erlitten hat, fällt normalerweise in Ohnmacht, bis die Blutung
wie beschrieben gestillt wird.
...
denen die dahinterstehende Handlung sehr einer Abwehr gleicht, können
auch ganz verfallen.

AP werden auch durch Schlafphasen, die \textbf{k"urze}r sind
...
Spielleiter gestatten, da"s auch durch echtes \textbf{Ausruhen} in
...
Bei der magischen Heilung von \textbf{schweren Verletzungen} reduziert
jeder durch die Behandlung geheilte LP die ausgew"urfelte Dauer der
schweren Verletzung um \textbf{einen Tag}. Nichtmagische Behandlung
verkürzt die Dauer der Verletzung nicht, weil nichtmagische Behandlung
ohnehin vorausgesetzt wird, damit die angegebene Dauer nicht deutlich
verlängert wird.

Wird eine Figur mit \textbf{negativen LP} magisch geheilt oder mit
\emph{Erster Hilfe} behandelt, so reicht es, wenn sie bis zum
\textbf{Beginn} der entsprechenden Handlung "uberlebt. W"ahrend der
Zauber- bzw. Behandlungsdauer bleibt sie auf jeden Fall am Leben. Ist
nach Abschlu"s der Behandlung bzw. des Zaubers die erw"urfelte
"Uberlebenszeit der Figur abgelaufen, stirbt sie sofort, wenn sie
durch den Heilzauber bzw. die Behandlung nicht bis auf mindestens
0\,LP gebracht wurde.
...
eintreten braucht (allerdings mu"s das Opfer \textbf{AP verlieren})
[DFR\,243], um die in Tabelle~4.5 beschriebenen Auswirkungen
hervorzurufen, gilt diese Regel bei gezielten Angriffen
\textbf{nicht}. Ein gezielter Angriff erzielt nur dann den
gew"unschten kritischen Schaden, wenn das Opfer \textbf{mindestens
  1\,LP} verliert. Diese Einschr"ankung gilt nicht, wenn der
\textbf{EW:Angriff} einen \textbf{kritischen Erfolg} ergeben hat und
der zweite WW:Abwehr mi"slungen ist. \textbf{Gelingt} allerdings der
\textbf{zweite WW:Abwehr}, so ist der angerichtete Schaden auf jeden
Fall nur \textbf{leicht}, selbst wenn der EW:Angriff einen kritischen
Erfolg ergeben hat.

\emph{Anmerkung: In der Standardregel sind gezielte Hiebe zu
  m"achtig. Es gibt nur wenige Situationen, in denen es nicht sinnvoll
  ist, ausschlie"slich mit gezielten Angriffen zu k"ampfen. Der
  angerichtete AP-Schaden ist z.\,B. genauso gro"s wie bei ungezielten 
  Hieben, die Chance, einen entscheidenden Treffer zu landen, ist
  jedoch viel gr"o"ser. Mit den hier vorgenommenen Regl"anderungen
  wird dieser Mi"sstand dadurch behoben, da"s ein K"ampfer, der einen
  gezielten Hieb landen will, auf die Chance verzichtet, durch
  diesen Hieb an anderer Stelle kritisch zu treffen. Durch die
  Bedingung, da"s kritischer Schaden nur bei LP-Verlust eintritt,
  werden die verheerenden M"oglichkeiten eines gezielten Hiebs weiter
  eingeschr"ankt. Ein "`echter"' kritischer Treffer simuliert
  gewisserma"sen das Zusammentreffen (un)gl"ucklicher Umst"ande, was
  nicht unbedingt bewu"st herbeizuf"uhren ist. Die M"oglichkeit, durch 
  gezielte Hiebe effizient gegen stark ger"ustete Gegner vorgehen zu
  k"onnen, wird durch eine andere Regelerg"anzung hergestellt (s.\,u.).}
  
Die Art des kritischen Treffers kann sich der Angreifer gem"a"s der
entsprechenden Tabelle [DFR\,248] aussuchen. Es gilt jedoch eine
Einschr"ankung, wenn der Angrifer sich "`100: T"odlicher Treffer"' aussucht.
Will er einen solchen Hieb landen, mu"s er sich zun"achst aussuchen, gegen
welche Stelle er den Hieb richtet (z.\,B. Herz oder Kehle). Ist der gezielte
Hieb erfolgreich und mi"slingen beide WW:Abwehr, dann mu"s dem Angreifer ein
\textbf{EW:Meucheln} gelingen, um das Opfer zu t"oten. Bei diesem EW
\textbf{entfällt} die sonst übliche \textbf{WM--Grad des Opfers}, weil die
bessere Abwehrchance höhergradiger Gegner bereits durch den WW:Abwehr
berücksichtigt wurde.  Mi"slingt dieser Wurf, wird an der entsprechenden
Stelle kritischer Schaden angerichtet (z.\,B. Herz: Rumpftreffer 21--35,
Kehle: Halstreffer 94--96). Dieses Verfahren ist jedoch nur bei ausreichend
\textbf{menschen"ahnlichen} Kreaturen m"oglich [DFR\,161]. Bei nicht
menschen"ahnlichen Kreaturen wird der EW:Meucheln durch einen passenden
anderen EW ersetzt, der f"ur das Wissen des Angreifers "uber die verwundbaren
Stellen der bek"ampften Kreatur steht. Dies kann z.\,B. bei tierischen Opfern
\emph{Tierkunde} sein. Gibt es keine passende Fertigkeit, mu"s der Spielleiter
entsprechend des abgesch"atzten Wissens des Angreifers "uber die angegriffene
Kreatur einen sinnvollen Erfolgswert festsetzen. 

Spezielle Regeln gelten im \textbf{Drachenkampf} aufgrund der verwundbaren
Stelle direkt "uber dem Herzen des Drachen.  Selbstverst"andlich sind gezielte
Hiebe auf diese Stelle nur dann m"oglich, wenn der Angreifer eine recht genaue
Vorstellung von Existenz und Ort dieser Stelle hat. Ein gezielter Hieb mit
\textbf{WM+4} auf den zweiten WW:Abwehr hat bei Erfolg lediglich den Vorteil,
da"s der Schaden mit RK=OR berechnet wird [BES\,58ff].  Kritischer Schaden
wird nur dann angerichtet, wenn der EW:Angriff einen kritischen Erfolg ergeben
hat (und der erste WW:Abwehr nicht kritisch erfolgreich und der zweite
WW:Abwehr nicht normal erfolgreich war), und zwar in diesem Falle
ausschlie"slich \textbf{21--35: Rumpftreffer}. Ein gezielter Hieb gegen das
Herz (mit WM+8 auf den zweiten WW:Abwehr) ist nur dann t"odlich, wenn ein
separater Wurf mit W20 ein Ergebnis liefert, das \textbf{h"oher ist als der
  Grad des Drachens} (ansonsten wird kritischer Schaden durch Rumpftreffer
angerichtet, vorausgesetzt es wurde mindestens 1\,LP geraubt). Auf diesen Wurf
k"onnen WM angewendet werden, die das Wissen des Angreifers "uber die Methode,
einen Drachen mit einem Schlag zu t"oten, widerspiegelt. Hat der Angreifer
z.\,B. nur sehr vages Wissen, kann WM--4 angewendet werden. Eine WM+0 steht
f"ur recht gutes Wissen, wie man es aus ausf"uhrlichen schriftlichen
Schilderungen oder den genauen Unterweisungen eines Experten gewinnen kann.
WM+2 (oder WM+4 oder noch mehr) k"onnte erreicht werden, wenn der Angreifer
schon einmal selber genau beobachten konnte, wie ein Drachen an seiner
verwundbaren Stelle (oder gar ins Herz) getroffen wurde (oder er diesen
Angriff sogar selber durchgef"uhrt hat).
...
Es ist auch m"oglich, einen gezielten Hieb nicht gegen bestimmte
K"orperteile zu richten, sondern gegen Schwachstellen der R"ustung. Es
ist nicht m"oglich, auf diesem Wege nat"urliche R"ustungen zu umgehen.
Der Angriff l"auft genauso ab wie ein normaler gezielter Hieb,
allerdings wird auf den \textbf{zweiten WW:Abwehr}
\mbox{\textbf{WM--RK}} angewendet.  Wird der Treffer nicht abgewehrt,
richtet er normalen \textbf{schweren Schaden} an, wobei jedoch die
\textbf{R"ustung nicht ber"ucksichtigt} wird. Ein kritischer Erfolg
beim EW:Angriff kann weiterhin mit einem normalen Erfolg beim zweiten
WW:Abwehr abgewehrt werden. Wird er allerdings nicht abgewehrt, wird
der kritische Schaden normal auf Tabelle S5 ausgew"urfelt, dann aber
ohne Ber"ucksichtigung der R"ustung ausgewertet (es sei denn, das
f"uhrt zu unsinnigen Ergebnissen).


\subsubsection{Fernkampf}

Da gezielte Schüsse und Würfe immer auf wehrlose Figuren erfolgen [DFR\,249],
erlangt man dabei niemals KEP. Allerdings können AEP vergeben werden für das
"`kampflose"' Überwinden eines Gegners.
...
jedoch ohne Einschr"ankung. Ein kritischer Erfolg hat die in [DFR\,250] 
beschrieben Auswirkungen, erm"oglicht jedoch nicht, kritischen Schaden 
ohne LP-Verlust anzurichten.

Auch im Fernkampf gilt, da"s ein gezielter Schu"s nur dann t"odlich sein kann,
wenn ein \textbf{EW:Meucheln} gelingt. Ansonsten wird der Schaden wie im
Nahkampf zu einem passenden kritischen Schaden "`abgemildert"'. Ein Schuß ins
Herz wird zu einem Rumpftreffer (21--35). Ein Schuß auf die Halsschlagader
wird zu einem Halstreffer (94--96). Ein Schuß durchs Auge ins Gehirn, wie im
Beispiel [DFR\,250], erfordert im Gegensatz zu den anderen beschriebenen
Schüssen nicht nur einen Gesamtwert von 25, sondern von 30. Auch hier tritt
die tödliche Wirkung nur nach einem erfolgreichen EW:Meucheln ein. Der
"`abgemilderte"' Schaden ist hier dann aber nicht nur eine Augenverletzung,
sondern eine schwere Schädelverletzung (97). Wenn ein Ergebnis von 25 bis 29
erzielt wird, dann ist die Folge des Treffers eine Augenverletzung (98--99).
Dies gilt natürlich nur für das große Echsenauge. Bei menschlichen Augen
müßten die nötigen Werte noch erhöht werden.

Zum Drachenkampf gelten sinngem"a"s die gleichen Regeln wie oben geschildert.
Um die ungerüstete ahndtellergroße Stelle zu treffen, muß ein Gesamtergebnis
von 25 wie in [BES\,59] beschrieben erzielt werden. Ein Treffer bewirkt in
jedem Falle, daß kein Rüstungsschutz angerechnet wird. Wird mindestens 1\,LP
Schaden angerichtet, dann ist dieser Treffer automatisch ein kritischer
Rumpftreffer. Tödlich ist der Treffer, wenn der Wurf gegen den Grad des
Drachen wie oben beschrieben gelingt.
...
vor, wobei fraglich ist, wie es dabei zu einer Benetzung des
...
Ein \textbf{Hyrrbauti} [MDS\,???] explodiert mit "`Zaubern+18"'.
...
Siegel und Zauberlettern für Thaumaturgen. Solange [MDS] noch nicht erschienen
ist, gilt die WM-2 allerdings nicht für Beschwörungen.
...
Im Gegensatz zu einigem, was in [DFR\,91] zu finden ist, wird das Zaubern in
Aktionsphasen mit sekundengenauem Handlungsablauf hier eindeutiger geklärt:

\begin{itemize}
\item Da es keinen klaren Rundenbeginn mehr gibt, kann man auch schlecht davon
  sprechen, daß ein Zauberer sich nicht mehr als 1\,m bewegen darf, wenn er in
  der "`laufenden Runde"' noch Zaubern will.
\item Stattdessen gilt folgendes: Jeder Zauber erfordert eine Mindestzeit von
  10\,sec, in der der Zauberer sich maximal 1\,m bewegen darf und wehrlos
  ist.
\item Auch in den 1W6 sec vor Beginn seiner Handlung (nach gescheitertem
  ...
  Zaubern ist.
\item Daher werden diese 1W6 sec auch auf die 10\,sec Mindestzeit angerechnet
  (was nur bei 1-sec- und 5-sec-Zaubern relevant ist).
\item Störungen in den 1W6 sec stören noch nicht die Konzentration des
  Zauberers. Dies ist nur während der eigentlichen Zauberdauer möglich.
...
\item Der Zauberer kann nach wie vor (auch während der 1W6 sec) den
  ...
  sec erfolgt. 
\item Wichtger Spezialfall bei 1-sec- und 5-sec-Zaubern: Hier ist es möglich,
  daß der Zaubervorgang schon vollendet wurde, bevor die 10 sec Mindestzeit
  verstrichen sind. In diesem Falle ist der Zauberer für den verbelibenden
  Anteil der 10 sec in jedem Falle wehrlos. Der Zaubervorgang kann ja nicht im
  Nachhinein abgebrochen werden.
\end{itemize}

\subsection{Thaumaturgie}

Der Tr"ager eines \textbf{Talismans} sp"urt intuitiv, wenn die Wirkung
des Talismans vorbei ist. 
...
\subsection{Beschw"orungen}

\emph{Anmerkung: Der Regelband \emph{Meister der Sphären} ist noch
  nicht erschienen. Daher beziehen sich die Angaben zu Beschwörungen
  noch auf die 3.  Auflage der Midgardregeln.}

Das \textbf{Verl"angern} ist nur m"oglich, wenn das beschworene Wesen
sich in maximal 50\,m Umkreis um den Beschw"orer aufh"alt
(Kommunikationsdistanz).

Ein kritischer Fehler beim \textbf{Tor schaffen} f"uhrt dazu, da"s das
Tor zu einem zuf"allig ausgew"ahlten anderen geeigneten Hexagon
f"uhrt. Ist so ein Hexagon nicht vorhanden, hat ein kritischer Fehler
keinen Effekt. Der Zaubernde bemerkt (wie grunds"atzlich immer), da"s
er einen kritischen Fehler gemacht hat. Ein EW:Resistenz gegen sich
selbt wird nicht durchgef"uhrt (da es sich formal um eine Beschw"orung
und nicht um einen Zauberspruch handelt).
...
Beim \textbf{Blitzeschleudern} wird der WW:Resistenz für jeden Blitz separat
...
der Zauberer sich selbst verzaubert hat).
...
Die mir dem Zaubersiegel \textbf{Unsichtbarkeit} verzauberten Personen 
...
Die Geldmengen bei \textsc{Midgard} wirken oft astronomisch, die
Kaufkraft des Goldes l"acherlich. Als Ausweg wird h"aufig eine
"`W"ahrungsreform"' gew"ahlt. Hier wird ein anderer Weg gegangen, der nur
wenige "Anderungen ben"otigt, aber einiger Erl"auterungen bedarf.
...
eine eventuell vorkommende W"ahrung, deren Wert nicht ann"ahernd
durch den Materialwert gedeckt ist, ist in L"andern, wo diese
W"ahrung nicht bekannt ist, gar nichts wert, usw.) sollten bewu"st
sein, ohne sie in all ihren nervenden Details auszuspielen. Die
Vorteile der \emph{Gesch"aftst"uchtigkeit} beruhen u.\,a.  darauf,
da"s die beschriebenen Tausch-, An- und Verkaufsverluste reduziert
werden. F"ur nicht explizit ausgespielte Lernphasen sind die
beschriebenen Verluste einer der Gr"unde daf"ur, warum die Lernkosten
so hoch erscheinen (s.\,o.). In Lernphasen sind also keine weiteren
Abz"uge aufgrund von Tauschverlusten mehr erforderlich.
...
ca. 24\,GS wert (irdischer Wert: 1961 21,20\,\euro, 1990 86\,\euro).
1\,kg der M"unzlegierung, aus der GS bestehen (60\,\%\ Gold, 40\,\%\ 
Silber), sind ca. 160\,GS wert. Das Silber davon hat einen Wert von
ca. 10\,GS, bleiben f"ur das Gold 150\,GS. Allerdings wird das Gold
durch Aufreinigung wertvoller. "`Normales"' \textbf{Handelsgold} hat
einen Goldanteil von ca. 90\,\%. 1\,kg dieses Goldes aus einer in
irgendeiner Form zertifizierten Quelle hat einen Wert von gut
\textbf{200\,GS}. Hochaufgereinigtes und als solches zertifiziertes
Feingold (\textbf{Alchimistengold}) hat einen Wert von mindestens
\textbf{500\,GS je kg}. (Zum Vergleich: Der irdische Goldpreis
unterliegt starken Schwankungen. Bis zum 17.3.1968 war der Goldpreis
gesetzlich festgelegt auf 574\,\euro/kg. Nach der Freigabe schwankte er
extrem stark mit dem H"ohepunkt Anfang 1980 bei fast 10.000\,\euro/kg.
1990 lag der Goldpreis bei ca. 6.500\,\euro/kg.) Stellt man sich vor,
da"s ein GS etwa einem Gegenwert von 5\,\euro\ entspricht, so erh"alt
man einen Goldpreis, der leicht unter dem irdischen liegt, und einen
Silberpreis, der leicht "uber dem irdischen liegt, eine Relation, die
im Hinblick auf die Aussage, da"s Gold auf \textsc{Midgard} h"aufiger
ist als auf der Erde, durchaus konsistent erscheint. Allerdings ist
mit derartigen Vergleichen "au"serst vorsichtig umzugehen. Die Rolle
des Geldes in einer altert"umlichen Fantasywelt ist nur sehr bedingt
vergleichbar mit der, die es in unserer heutigen Welt spielt. In einer
bestimmten Situation kann die Kaufkraft eines GS der eines einzigen
Euro (oder noch weniger, schlie"slich kann man weder Geld noch Gold
essen) entsprechen oder auch der von 100\,\euro.



\subsection{Sex, Liebe, Leidenschaft\dots}
Mit der 4.~Auflage des Regelwerks sind die Stellen, die den Eindruck erwecken,
als ob \textsc{Midgard} nur Heterosexulit"at kenne, deutlich weniger geworden,
...
so geht der Spielleiter flexibel vor und vergibt passende WM auf entsprechende
...
\begin{tabular}{|p{16.5cm}|}
  \hline
  \textbf{Beispiel:} \emph{Die schwarze Hexe
    Xenia macht sich an Ipak, den gutaussehenden Gl"ucksritter der
    Abenteurergruppe, heran. Sie hat vor, die Gruppe zu
    schw"achen, indem sie Ipak mittels eines Liebeszaubers an sich
    binden und in einem g"unstigen Moment beseitigen wird. Was sie
    nicht wei"s: Ipak ist schwul.  Verf"uhrungsversuche und auch
    Liebeszauber des weiblichen Geschlechts werden nicht v"ollig
    aussichtslos sein (ein Gl"ucksritter bleibt ein Gl"ucksritter
    und ist immer offen f"ur neuartige Erfahrungen, Xenia ist
    obendrein extrem gutaussehend und charismatisch), aber doch um
    ein geh"origes Ma"s erschwert. Der Spielleiter entscheidet
    also, Ipak WM+8 auf seinen WW:psyZR zu gew"ahren. -- Nachdem
    Xenia von Ipak einen freundschaftlichen Korb erhalten hat,
    probiert sie es mit dem zweiten m"annlichen Mitglied der
    Gruppe, dem Priester Fares. Fares lebt gem"a"s den
    Vorschriften seiner Glaubensgemeinschaft streng keusch. Da er
    wahrhaft gottesf"urchtig ist, ist dies nicht nur ein
    Lippenbekenntnis, sondern seine tiefste "Uberzeugung. Xenia
    wird es mit ihm "ahnlich schwer haben wie mit Ipak, selbst
    wenn Fares eigentlich heterosexuell ist (was aber aufgrund des
    "uberzeugten Z"olibats relativ unwichtig ist). Eine tiefe
    "Uberzeugung wiegt genauso schwer wie eine biologische oder
...
\section{Abstufungen der Handlungsunf"ahigkeit}

Zur besseren "Ubersicht "uber die m"oglichen Einschr"ankungen der
Handlungsf"ahigkeit dient Tabelle~\ref{tab:handlung}.
...
{\small
  \begin{center}
    \begin{tabular}{|c|p{6cm}|p{8cm}|}
      \hline
      \textbf{Stufe} & \textbf{Folgen} & \textbf{Situation}\\
      \hline \hline
      0 & voll handlungsf"ahig &
      \begin{minipage}{8cm}
        \vspace*{1mm}
        \begin{itemize}
      ...
      \end{minipage}\\
      \hline
      1 & automatischer Verlust der Initiative &
      \begin{minipage}{8cm}
        \vspace*{1mm}
        \begin{itemize}
        \item leichte "Uberraschung
        \end{itemize}
        \vspace*{1mm}
      \end{minipage}\\
      \hline
      2a & kein Angriff möglich&
      \begin{minipage}{8cm}
        \vspace*{1mm}
        \begin{itemize}
        \item Schock nach kritischem Treffer 11--20
        \item spezielle Situation im Faustkampf [DFR\,197f]
        \end{itemize}
        \vspace*{1mm}
      \end{minipage}\\
      \hline
      2b & Angreifer erh"alt WM+4 auf Angriff&
      \begin{minipage}{8cm}
        \vspace*{1mm}
        \begin{itemize}
        \item Nahkampf: Opfer am Boden liegend (Opfer erhält WM--4 auf
          eigene Angriffe)
        \item Nahkampf: Opfer flieht panisch
        \item Fernkampf: Angreifer konnte sorgf"altig zielen
        \item Opfer im Handgemenge
        \end{itemize}
        \vspace*{1mm}
      \end{minipage}\\
      \hline
      3 & keine Handlung au"ser Abwehr, WM--4 auf Abwehr &
      \begin{minipage}{8cm}
        \vspace*{1mm}
        \begin{itemize}
        \item schwere "Uberraschung
        \item die erste Runde, in der man während der Aufwachzeit
          [DFR\,108] angegriffen wird
        \item w"ahrend 30\,min (bzw. 60\,min) nach kritischem Kopftreffer 74--80
        \end{itemize}
        \vspace*{1mm}
      \end{minipage}\\
      \hline
      4 & keine Abwehr, Angreifer erh"alt im Nahkampf und Handgemenge WM+4 &
      \begin{minipage}{8cm}
        \vspace*{1mm}
        \begin{itemize}
        \item "`klassische"' Wehrlosigkeit [DFR\,95]
        \item Opfer hat 0\,AP (Opfer
          erh"alt auf eigene Angriffe WM--4 [DFR\,101])
        \item Opfer hat 1-3\,LP (Opfer kann keine Handlungen mehr
          ausf"uhren, B4)
        \item Opfer hat 0\,LP (Opfer kann keine Handlungen mehr
          ausf"uhren, B0)
        \item kritische Beinverletzung (B6)
        \item Ahnungslosigkeit (meucheln möglich)
        \item Opfer wird in Schach gehalten [DFR\,95]
        \end{itemize}
        \vspace*{1mm}
      \end{minipage}\\
      \hline
      5 & Angreifer trifft automatisch schwer &
      \begin{minipage}{8cm}
        \vspace*{1mm}
        \begin{itemize}
        \item keine konkrete Regel bekannt, aber denkbar als Spielleiterentscheidung
        \end{itemize}
        \vspace*{1mm}
      \end{minipage}\\
      \hline
      6 & Angreifer trifft automatisch kritisch -- bei EW:Meucheln (mit
      WM--Grad, wenn Reflexe noch eine Rolle spielen können) wird Opfer get"otet&
      \begin{minipage}{8cm}
        \vspace*{1mm}
        \begin{itemize}
        \item v"ollige Bewegungsunf"ahigkeit des Opfers
        \item Opfer bewußtlos
        \item Opfer schläft (i.\,d.\,R. muß dem Angreifer ein
          EW:Schleichen (vgl. Anmerkungen zu \emph{Schleichen} oben)
          gelingen, damit er nah genug an das Opfer herankommt, um
          diesen Angriff durchzuführen -- erwacht das Opfer durch
          mißglücktes Schleichen (EW mißglückt, WW gelingt), tritt
          Stufe 3 ein)
        \end{itemize}
        \vspace*{1mm}
      \end{minipage}\\
      ...
      \begin{minipage}{8cm}
        \vspace*{1mm}
        \begin{itemize}
        \item v"ollige Bewegungsunf"ahigkeit des Opfers, Angreifer ist 
          ungest"ort und hat gen"ugend Zeit (in der Regel au"serhalb
          von Aktionsphasen)
        \end{itemize}
        \vspace*{1mm}
      \end{minipage}\\
      \hline
    \end{tabular}
    \caption{Stufen der Handlungsunf"ahigkeit}
    \label{tab:handlung}
  \end{center}
}
\end{table}
