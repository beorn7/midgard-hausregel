...
\title{Regelklarstellungen, -änderungen und -ergänzungen f"ur
  \textsc{Midgard} (4. Auflage)\\Version 2.3}
...
\item \emph{\textbf{Geschäftstüchtigkeit: }}Abweichend vom Regelwerk spart
  ...
  Lebensunterhalt.)
\item \textbf{\emph{Meucheln: }}Nach [DFR\,160ff] mu"s mindestens 1\,LP
...
verlängert wird. (Die magische Behandlung ersetzt \emph{nicht} die
nichtmagische Behandlung.)
