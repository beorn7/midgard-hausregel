...
\usepackage{german,anysize,eurosym,tabu}
...
\title{Hausregeln f"ur
  \textsc{Midgard} (4. Auflage)\\Version 2.11}
...
\textsc{Midgard}-Regeln sind den Erfahrungen un\-zäh\-liger Midgardsitzungen
...
DFR = Das Fantasy-Rollenspiel, ARK = Das Arkanum, KOM = Das
Kompendium, BES = Das Bestiarium, MDS = Meister der Sphären. Der
Begriff \emph{Figur} (als "`altdeutsche"' Version von englisch
\emph{Character} oder eingedeutscht \emph{Charakter}) ist in den
jüngeren \textsc{Midgard}-Auflagen irgendwie der Vergessenheit anheim
gefallen, erfreut sich hier aber noch reger Benutzung. Also: SpF =
Spielerfigur = \emph{player character} = PC = "`Abenteurer"' =
"`Held"'. NSpF = Nichtspielerfigur = \emph{non-player character} = NPC.
...
einfachsten, wenn der Spielleiter zunächst heimlich die Handlungen für
...
{\footnotesize
  \begin{center} 
    \begin{tabu}{|p{2.4cm}||p{4.5cm}|p{4.3cm}|p{4.4cm}|}
      \hline
      ...
      \item Rundumschlag
      \item Opfer hat weniger als die Hälfte LP (WM--2)
      \end{itemize} & 
      \begin{itemize}
      ...
      \end{itemize} &
      \begin{itemize}
      \item Opfer wird im Handgemenge festgehalten (WM+4)
      \end{itemize}
      \\
      \hline
      WM+4 auf Angriff des Gegners, keine Abwehr &
      \begin{itemize}
