...
Der Einsatz von \textbf{angeborenen Fähigkeiten, die wie Zauberei
  wirken} [BES\,20], zählt grundsätzlich (also wenn nicht ausdrücklich
anders geregelt) als Handlung, die das Wesen normalerweise eine ganze
Runde beschäftigt, auch wenn keine Konzentration nötig ist (und damit
weiterhin Angriffe abgewehrt werden können, was aber keine Handlung
darstellt). Wie bei M5 klargestellt, ist die Zauberdauer grundsätzlich
1\,sec (so nicht ausdrücklich anders geregelt).
