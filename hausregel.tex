...
\title{Hausregeln f"ur
  \textsc{Midgard} (4. Auflage)\\Version 2.6}
...
dann in \textbf{Handlungs- bzw. Angriffsrangreihenfolge
  durchgef"uhrt}. Eine angesagte Handlung kann im Nachhinein
\textbf{nicht mehr ge"andert} werden (mit der Ausnahme einiger
spezieller Situationen, in denen die Regeln dies explizit
erlauben). Allerdings ist es m"oglich, auf die Ausübung der angesagten
Handlung zu \textbf{verzichten}, wenn man an der Reihe ist. (Manchmal
hat man auch gar keine andere Wahl\dots)
...
nicht bewegen kann. Der Zustand der Handlungsunfähigkeit hält für den
Rest der laufenden und für die gesamte folgende Runde an. Nur beim
Simulieren eines sekundengenauen Handlungsablauf kommen die 10~sec zur
Geltung, die in der Regel erwähnt werden. 
...
spielen und durchaus verhoppelt werden können. Entsprechendes gilt für
