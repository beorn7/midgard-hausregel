...
\usepackage{german,anysize,eurosym,tabu,enumitem}
...
\title{Hausregeln f"ur
  \textsc{Midgard} (4. Auflage)\\Version 2.12}
...
"`Held"'. NSpF = Nichtspielerfigur = \emph{non-player character} =
NPC. Die Schreibweise \textsc{Midgard} bezieht sich auf das
Regelsystem, während die Spielwelt \emph{Midgard} als Midgard
bezeichnet wird.
...
wie \emph{Blutmeisterschaft} und den \emph{Klängen der Genesung}
...
Die Fertigkeit \emph{Werfen} [DFR\,208] kann \emph{nicht für gezielte
...
Handlung ist, vgl. Anhang \ref{behindert}).
