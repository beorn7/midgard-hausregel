...
\title{Hausregeln f"ur
  \textsc{Midgard} (4. Auflage)\\Version 2.10}
...
"Uberwindung eines Gegners [DFR\,270f], wobei der Multiplikator für
KEP-Vergabe auch bei den so vergebenen AEP Berücksichtigung finden
kann (Faustregel: Die Anzahl an AEP für die Überwindung eines Gegners
entspricht der Anzahl an KEP, die es gegeben hätte, wenn dem Gegner
alle AP durch Fernkampfangriffe geraubt worden wären.)
...
werden konnten. Davon unbeschadet bleibt die Möglichkeit, durch
separate Anwendung von \emph{Allheilung} in einem Zauberduell die
Folgen derartiger Verletzungen direkt zu beseitigen [ARK\,85]. Die
Restgenesungsdauer kann weiterhin duch Zauber wie
\emph{Blutmeisterschaft} und \emph{den Klängen der Genesung} verkürzt
werden. Ausdrücklich ausgenommen von dieser Regelung ist allerdings
die \emph{Wundrune} (deren Vorteil darin besteht, daß sie beliebig
häufig hintereinander angewendet werden kann, was aber nicht zur
vollständigen Beseitung der Folgen oben genannter Verletzungen in
...
ihre Fähigkeit zur \emph{Abwehr} aussagt (was ja formal keine
...
Die \emph{Wundrune} ist von der Regelung zur Behandlung tödlich
...
Einschränkungen bei der Heilung schwerer Verletzungen.)
...
Handlungsf"ahigkeit dient Tabelle~\ref{tab:handlung}. Zu beachten ist,
daß die Liste nicht streng linear ist. Eine höher nummerierte
Abstufung ist nicht unbedingt in jeder Hinsicht eine stärkere
Beeinträchtigung. Insbesondere ist regeltechnisch Abwehr keine
Handlung. Handlungsunfähigkeit impliziert also nicht notwendigerweise
Wehrlosigkeit, und auch nicht umgekehrt. Bei der "`klassischen"'
Wehrlosigkeit, wie sie z.B. einsetzt, wenn das Opfer keine AP mehr
hat, ist das Opfer durchaus noch handlungfähig (wenn auch
möglicherweise mit WM--4).

\begin{table}[htbp]
  {\small \begin{center} \begin{tabular}{|c|p{6cm}|p{8cm}|} \hline
        \textbf{Stufe} & \textbf{Folgen} & \textbf{Situation}\\
        \hline \hline 0 & voll handlungsf"ahig & \begin{minipage}{8cm}
          \vspace*{1mm} \begin{itemize} \item
            Standardsituation \end{itemize} \vspace*{1mm}
        \end{minipage}\\
        \hline 1 & automatischer Verlust der Initiative
        & \begin{minipage}{8cm} \vspace*{1mm} \begin{itemize} \item
            leichte "Uberraschung \end{itemize} \vspace*{1mm}
        \end{minipage}\\
        \hline 2a & kein Angriff möglich (und i.\,d.\,R. auch keine
        anderen Handlungen außer Abwehr -- Handlungsunfähigkeit im
        eigentlichen Sinne)&
      \begin{minipage}{8cm}
        \vspace*{1mm}
        \begin{itemize}
