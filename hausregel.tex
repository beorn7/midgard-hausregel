...
\title{Hausregeln f"ur
  \textsc{Midgard} (4. Auflage)\\Version 2.5}
...
nach Abschluß aller Bewegungen [DFR\,87] wird in derselben Reihenfolge
durchgeführt wie die Bewegungen selbst.

\subsection{Handlung}

Handlungen werden (theoretisch) \textbf{gleichzeitig angesagt} und
dann in \textbf{Handlungs- bzw. Angriffsrang-Reihenfolge
...
Auch im Fernkampf gilt, da"s ein gezielter Schu"s nur dann
augenblicklick t"odlich sein kann, wenn prinzipiell die Möglichkeit
dazu besteht und zusätzlich der Schütze von dieser Möglichkeit weiß.
...
nötig. Außerdem muß mit beiden Würfen eine 30 erreicht und mindestens
1\,LP Schaden angerichtet werden.

\subsection{Verschiedenes}

\textbf{Spontane} und \textbf{überstürzte Angriffe} [DFR\,224] können
nicht mit anderen Spezialregeln kombiniert werden. Solche Angriffe
können nicht gezielt geführt werden, sie können nicht mit Fechten
kombiniert werden, nicht zum Einsatz von konzentrierter Abwehr benutzt
werden etc.
