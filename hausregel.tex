...
\item Der \textbf{automatische} EW f"ur Entdeckungs- und Wissensfertigkeiten
  ...
  SpL-Entscheidung auch ein \textbf{normaler Erfolg} reichen, und ein
...
vergeben werden, ersetzt eine SpL-Entscheidung den zweiten
EW. Es wird also nicht mehr "`hinterhergewürfelt"' für den PP. Der
SpL entscheidet, ob die Situation die Vergabe eines PP
...
ihre Fähigkeit zur \emph{Abwehr} aussagt (was ja formal keine Handlung
...
erfolgt mit \textbf{WM+4} auf den 2. WW:\emph{Abwehr}, hat aber keinen
...
(ausgenommen Kampfriemen, Tonfa und YoTenTori), sich in der laufenden
...
\item \label{i:zusatz} Zusatzangriffe, die ohne die jeweilige
  ...
  beiden zuletzt genannten Möglichkeiten, die ja erst möglich sind,
  wenn zunächst ein regulärer Angriff (oder eine konzentrierte Abwehr)
  durchgeführt wird (z.\,B. könnte nach einem gezielten Rapierangriff
  ein Zusatzangriff mit \emph{Fechten} durchgeführt werden).
\item \label{i:ersatz} Spezielle Angriffe, für die die Aktion 2d
  ...
  speziellen Angriff ersetzt wird: gezielter Angriff, Rundumschlag,
  Entwaffnen (nur mit bestimmten Waffen möglich), Mehrfachangriff mit
  schneller Waffe (z.\,B. NunChaku), Anwendung von \emph{Kampf in
    Dunkelheit}, \emph{beidhändigem Kampf} bzw. \emph{Kampf in
  ...
  Angriffsweisen aus dieser Gruppe auch \textbf{nicht miteinander}
...
\fbox{\parbox{0.98\textwidth}{%
  \textbf{Beispiel:} \emph{Die schwarze Hexe
    ...
    ein geh"origes Ma"s erschwert. Der SpL entscheidet
