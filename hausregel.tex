...
\title{Regelklarstellungen, -änderungen und -ergänzungen f"ur
  \textsc{Midgard} (4. Auflage)\\Version 2.2}
...
Abenteurs, einer Lernphase oder wann auch immer steigern. Dies erfordert immer
...
allerdings keine besonderen Maßnahmen zu ergreifen sind und dieses
...
Einschr"ankung, wenn der Angrifer sich "`100: T"odlicher Treffer"'
aussucht.  Will er einen solchen Hieb landen, mu"s er sich zun"achst
aussuchen, gegen welche Stelle er den Hieb richtet (z.\,B. Herz oder
Kehle). Ist der gezielte Hieb erfolgreich und mi"slingen beide
WW:Abwehr, dann mu"s dem Angreifer ein \textbf{EW:Meucheln} gelingen,
um das Opfer zu t"oten. Bei diesem EW \textbf{entfällt} die sonst
übliche \textbf{WM--Grad des Opfers}, weil die bessere Abwehrchance
höhergradiger Gegner bereits durch den WW:Abwehr berücksichtigt wurde.
Mi"slingt dieser Wurf, wird an der entsprechenden Stelle kritischer
Schaden angerichtet, der auch schon bei Verlust von nur 1\,LP als
\textbf{besonders schwere Verletzung} zählt (z.\,B. Herz: Rumpftreffer
21--35, Kehle: Halstreffer 94--96). Dieses Verfahren ist jedoch nur
bei ausreichend \textbf{menschen"ahnlichen} Kreaturen m"oglich
[DFR\,161]. Bei nicht menschen"ahnlichen Kreaturen wird der
EW:Meucheln durch einen passenden anderen EW ersetzt, der f"ur das
Wissen des Angreifers "uber die verwundbaren Stellen der bek"ampften
Kreatur steht. Dies kann z.\,B. bei tierischen Opfern \emph{Tierkunde}
sein. Gibt es keine passende Fertigkeit, mu"s der Spielleiter
entsprechend des abgesch"atzten Wissens des Angreifers "uber die
angegriffene Kreatur einen sinnvollen Erfolgswert festsetzen.

Spezielle Regeln gelten im \textbf{Drachenkampf} aufgrund der
verwundbaren Stelle direkt "uber dem Herzen des Drachen.
Selbstverst"andlich sind gezielte Hiebe auf diese Stelle nur dann
m"oglich, wenn der Angreifer eine recht genaue Vorstellung von
Existenz und Ort dieser Stelle hat. Ein gezielter Hieb mit
\textbf{WM+4} auf den zweiten WW:Abwehr hat bei Erfolg lediglich den
Vorteil, da"s der Schaden mit RK=OR berechnet wird [BES\,58ff].
Kritischer Schaden wird nur dann angerichtet, wenn der EW:Angriff
einen kritischen Erfolg ergeben hat (und der erste WW:Abwehr nicht
kritisch erfolgreich und der zweite WW:Abwehr nicht normal erfolgreich
war), und zwar in diesem Falle ausschlie"slich \textbf{21--35:
  Rumpftreffer}. Ein gezielter Hieb gegen das Herz (mit WM+8 auf den
zweiten WW:Abwehr) ist nur dann t"odlich, wenn ein separater Wurf mit
W20 ein Ergebnis liefert, das \textbf{h"oher ist als der Grad des
  Drachens} (ansonsten wird kritischer Schaden durch Rumpftreffer
angerichtet, der als \textbf{besonders schwere Verletzung} zählt,
vorausgesetzt es wurde mindestens 1\,LP geraubt). Auf diesen Wurf
k"onnen WM angewendet werden, die das Wissen des Angreifers "uber die
Methode, einen Drachen mit einem Schlag zu t"oten, widerspiegelt. Hat
der Angreifer z.\,B. nur sehr vages Wissen, kann WM--4 angewendet
werden. Eine WM+0 steht f"ur recht gutes Wissen, wie man es aus
ausf"uhrlichen schriftlichen Schilderungen oder den genauen
Unterweisungen eines Experten gewinnen kann.  WM+2 (oder WM+4 oder
noch mehr) k"onnte erreicht werden, wenn der Angreifer schon einmal
selber genau beobachten konnte, wie ein Drachen an seiner verwundbaren
Stelle (oder gar ins Herz) getroffen wurde (oder er diesen Angriff
sogar selber durchgef"uhrt hat).
...
Um die ungerüstete handtellergroße Stelle zu treffen, muß ein Gesamtergebnis
...
\item Der Zauberer kann nach wie vor (auch während der 1W6 sec) den
  ...
  sec erfolgt. 
\item Wichtiger Spezialfall bei 1-sec- und 5-sec-Zaubern: Hier ist es möglich,
  daß der Zaubervorgang schon vollendet wurde, bevor die 10 sec Mindestzeit
  verstrichen sind. In diesem Falle ist der Zauberer für den verbleibenden
...
\textbf{Handelsgold} hat einen Goldanteil von ca. 90\,\%. 1\,kg dieses
Goldes aus einer in irgendeiner Form zertifizierten Quelle hat einen
Wert von gut \textbf{250\,GS}. Hochaufgereinigtes und als solches
zertifiziertes Feingold (\textbf{Alchimistengold}) hat einen Wert von
mindestens \textbf{500\,GS je kg}. (Zum Vergleich: Der irdische
Goldpreis unterliegt starken Schwankungen, bedingt durch Spekulation,
wechselnde Bestrebungen, Währungen durch Gold zu decken, und vieles
mehr.  In den 1950er und 1960er Jahren lag der Goldpreis recht stabil
bei knapp 3.000\,\euro/kg. Nachdem die Golddeckung des US-\$
aufgegeben wurde, schwankte der Preis extrem stark mit dem vorläufigen
H"ohepunkt Anfang 1980 bei fast 25.000\,\euro/kg. Nach einer Talsohle
bei etwa 8.000\,\euro/kg in den 1990ern erreichte der Goldkurs Ende
2009 fast wieder seinen Rekordkurs (wobei all diese Zahlen nicht
inflationsbereinigt sind).) Stellt man sich vor, da"s ein GS etwa
einem Gegenwert von 10\,\euro\ entspricht, so erh"alt man (bezogen auf
die irdischen 1990er Jahre) einen Goldpreis, der leicht unter dem
irdischen liegt, und einen Silberpreis, der leicht "uber dem irdischen
liegt, eine Relation, die im Hinblick auf die Aussage, da"s Gold auf
\textsc{Midgard} h"aufiger ist als auf der Erde, durchaus konsistent
erscheint. Allerdings ist mit derartigen Vergleichen "au"serst
vorsichtig umzugehen. Die Rolle des Geldes in einer altert"umlichen
Fantasywelt ist nur sehr bedingt vergleichbar mit der, die es in
unserer heutigen Welt spielt. In einer bestimmten Situation kann die
Kaufkraft eines GS der eines einzigen Euro (oder noch weniger,
schlie"slich kann man weder Geld noch Gold essen) entsprechen oder
auch der von 100\,\euro.
